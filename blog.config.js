...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '芯茂科技', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '芯茂科技', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xm-semi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '半导体, 官网', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '2022 浙ICP备18388899号-1', // 备案号 闽ICP备XXXXXX
